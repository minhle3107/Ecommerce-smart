    ...
    <section class="overflow-hidden bg-white py-11 font-poppins dark:bg-gray-800">
        <div class="max-w-6xl px-4 py-4 mx-auto lg:py-8 md:px-6">
            <div class="flex flex-wrap -mx-4">
                ...
                <div class="w-full mb-8 md:w-1/2 md:mb-0 z-[1]" x-data="{ mainImage: '{{ url('storage', $product->images[0]) }}' }">
                    <div class="sticky top-0 z-50 overflow-hidden ">
                        ...
                        <div class="flex-wrap hidden md:flex ">
                            @foreach ($product->images as $item)
                                <div class="w-1/2 p-2 sm:w-1/4" x-on:click="mainImage='{{ url('storage', $item) }}'">
                                    <img src="{{ url('storage', $item) }}" alt="{{ $product->name }}"
                    ...
                    <div class="lg:pl-20">
                        <div class="mb-8 ">
                            <h2 class="max-w-xl mb-6 text-2xl font-bold dark:text-gray-400 md:text-4xl">
                                {{ $product->name }}</h2>
                            <p class="inline-block mb-6 text-4xl font-bold text-red-600 dark:text-gray-400 ">
